...
*/
console.log("prima della funzione", charactersNames.length)

let femaleCharactersname = []
for (let i = 0; i < femaleCharacters.length; i++) {
  femaleCharactersname.push(femaleCharacters[i].name)
}
console.log(femaleCharactersname)

for (let i = 0; i < charactersNames.length; i++) {
  if (femaleCharactersname.includes(charactersNames[i])) {
    charactersNames.splice(i, 1)
  }
}
console.log(femaleCharactersname.length)
...
function myfunc() {
  ...
  let randomCharacter = starWarsCharacters[random]

  console.log(
    "Questo è uno dei personaggi di Star wars: il suo nome è ",
